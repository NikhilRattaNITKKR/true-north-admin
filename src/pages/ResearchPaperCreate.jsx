...
import { createResearchPaper } from '../services/researchPapers';
...
export default function CreateResearchPaper() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.file) {
      toast.error('Please upload a research paper file');
      setIsSubmitting(false);
      return;
    }
    ...
    try {
      const response = await createResearchPaper(researchPaperData);
      console.log('Research paper created successfully:', response);
      ...
      const errorMessage = error.response?.data?.message || 'Failed to create research paper';
        ...
        <div className="min-h-screen py-16 px-4 w-full flex justify-center items-center">
          <div className="max-w-4xl mx-auto w-full flex flex-col items-center justify-center">
            ...
            <div className="text-center mb-12">
              <h1 className="text-3xl font-bold text-gray-900 mb-3">Create New Research Paper</h1>
              <p className="text-gray-600 text-lg">Share your research paper with the community</p>
            </div>
            ...
            <div className="overflow-hidden w-full">
              <form onSubmit={handleSubmit} className="p-10" encType="multipart/form-data">
                ...
                <div className="flex justify-center items-center w-full gap-4 pt-8 mt-8 border-t border-gray-100">
                  ...
                  >
                    {isSubmitting ? 'Creating...' : 'Create Research Paper'}
                  </button>
                </div>
              </form>
            </div>
