...
import { getCaseStudy, updateCaseStudy, setFeaturedCaseStudy } from '../services/caseStudies';
  ...
  const handleFeaturedChange = async (e) => {
    ...
    try {
      if (newFeaturedStatus) {
        ...
        toast.info('To unset featured status, set another case study as featured');
        ...
        <div className="min-h-screen py-16 px-4 w-full flex justify-center items-center">
          <div className="max-w-4xl mx-auto w-full flex flex-col items-center justify-center">
            ...
            <div className="text-center mb-12">
              <h1 className="text-3xl font-bold text-gray-900 mb-3">Edit Case Study</h1>
              <p className="text-gray-600 text-lg">Update your case study information</p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="p-10" encType="multipart/form-data">
                ...
                <div className="mb-10">
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                    <div>
                      <h3 className="text-sm font-semibold text-gray-800">Featured Case Study</h3>
                      <p className="text-sm text-gray-500">Set this case study as the featured case study on the landing page</p>
                    </div>
