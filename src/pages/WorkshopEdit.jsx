...
export default function EditWorkshop() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await updateWorkshop(id, workshopData);
        ...
        <div className="min-h-screen py-16 px-4 w-full flex justify-center items-center">
          <div className="max-w-4xl mx-auto w-full flex flex-col items-center justify-center">
            ...
            <div className="text-center mb-12">
              <h1 className="text-3xl font-bold text-gray-900 mb-3">Edit Workshop</h1>
              <p className="text-gray-600 text-lg">Update your workshop information</p>
            </div>
